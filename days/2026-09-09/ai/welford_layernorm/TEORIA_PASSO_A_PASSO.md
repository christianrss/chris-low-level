# Teoria passo a passo — welford_layernorm
...
| ID | Papel |
|----|-------|
| `D7-WEL-MEAN` | assert do teste |
| `D7-WEL-VAR` | assert do teste |
| `D7-WEL-NORM` | assert do teste |

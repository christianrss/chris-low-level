# Teoria passo a passo — Tokenizer + merge de runs

Este laboratório é em **Python**.

## 1. O que estamos construindo

Bytes/chars → ids; merge_runs comprime runs; vocab_size conta distintos — ponte para BPE.
...
soma dos counts do merge = len(ids).

## Ligação

Dia 06 RLE; Dia 09 attention.

## Paper

Escreva [(97,3),(98,1)] antes de codar.
...
### Por quê medir?
O `BENCHMARK_GUIADO.md` pede a métrica `1e5 merge_runs` — mesmo que o ambiente
...
Neste módulo `ai/capstone_tokenizer`, o fluxo de dados não é abstrato: cada função do starter

...
Implemente `transition` em `starter/tool_protocol_fsm.py`.
Critério de aceite: o `PEDAGOGY-TEST` ligado a `AGT-TOOL-01` PASS; valores iguais ao paper-trace.

## Difícil — `AGT-TOOL-02` + `AGT-TOOL-03`

Complete `handle_response` e `validate_tool_call` mantendo invariantes dos passos anteriores.

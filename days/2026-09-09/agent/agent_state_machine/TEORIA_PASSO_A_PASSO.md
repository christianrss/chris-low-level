# Teoria passo a passo — agent_state_machine
...
| ID | Papel |
|----|-------|
| `D7-AGENT-TRANSITIONS` | assert do teste |
| `D7-AGENT-RUN` | assert do teste |
| `D7-AGENT-TRACE` | assert do teste |

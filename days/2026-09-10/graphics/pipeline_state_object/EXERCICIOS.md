# Exercícios — FSM de pipeline state object

Cada nível mapeia aos TODOs `CAP-GFX-PSO-01`, `CAP-GFX-PSO-02`, `CAP-GFX-PSO-03`.

## Fácil

Liste 3 arestas válidas no papel.

**Arquivo-alvo:** `starter/pipeline_state_object.py`  

...
**Trilha:** `graphics` · **Dia:** 2026-09-08

## O que você constrói

Implementação low-level com TODOs `GFX-SHADER-FSM-01`, `GFX-SHADER-FSM-02`, `GFX-SHADER-FSM-03`. Leia a TEORIA (trace numérico) antes do starter.

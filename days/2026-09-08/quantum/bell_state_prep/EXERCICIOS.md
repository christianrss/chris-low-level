...
Implemente `q_reset` em `starter/bell.cpp`.
Critério de aceite: o `PEDAGOGY-TEST` ligado a `Q-BELL-01` PASS; valores iguais ao paper-trace.

## Difícil — `Q-BELL-02` + `Q-BELL-03`

Complete `q_h0` e `q_cnot` mantendo invariantes dos passos anteriores.

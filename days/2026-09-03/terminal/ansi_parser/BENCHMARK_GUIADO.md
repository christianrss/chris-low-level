# Benchmark guiado - Terminal: parser ESC/CSI
...
7. O benchmark de referencia esta em `projects/chris-terminal/benchmarks/` quando existe.
...
|---------|------------------|-------|
| Parser throughput | ~447 MiB/s | 20 MiB input |

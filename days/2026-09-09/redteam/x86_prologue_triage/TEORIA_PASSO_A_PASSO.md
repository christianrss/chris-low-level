# Teoria passo a passo — x86_prologue_triage
...
| ID | Papel |
|----|-------|
| `D7-X86-PUSH` | assert do teste |
| `D7-X86-MOV` | assert do teste |
| `D7-X86-STACK` | assert do teste |

...
// Caso 1: `python starter/test_blob_triage.py` — magic gzip e zlib.
// Caso 2: **1F8B:** fixture gzip reconhecida.
// Caso 3: **789C:** header zlib default reconhecido.
// Caso 4: **Limites:** blob grande rejeitado por validate_size_limits.

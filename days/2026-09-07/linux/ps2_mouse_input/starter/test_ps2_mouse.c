// PEDAGOGY-TEST: PS2-MOUSE-DECODE-01
// PEDAGOGY-TEST: PS2-MOUSE-EVENT-02
// PEDAGOGY-TEST: PS2-MOUSE-RING-03
// PEDAGOGY-TEST: PS2-MOUSE-READ-04
// PEDAGOGY-TEST: PS2-MOUSE-DECODE-01: decode 3-byte PS/2 packet with sign bits
// PEDAGOGY-TEST: PS2-MOUSE-EVENT-02: emit REL_X/REL_Y and BTN press/release
// PEDAGOGY-TEST: PS2-MOUSE-RING-03: push InputEvent into ring buffer
// PEDAGOGY-TEST: PS2-MOUSE-READ-04: read() drains events FIFO
// Test cases (TESTES_GUIADOS.md):
// Caso 1: Compile e execute ps2_mouse_test em starter/ (falha até implementar TODOs).
// Caso 2: Fixture move_right_up.raw → dx=5 dy=3.
// Caso 3: left_down.raw após move gera BTN_LEFT value 1.
// Caso 4: Ring overflow retorna -1; read preserva ordem.
// Caso 5: sizeof(InputEvent)==24.

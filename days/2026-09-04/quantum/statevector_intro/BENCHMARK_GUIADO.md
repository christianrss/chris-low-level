# Benchmark guiado — Quantum state-vector do zero
...
## Build
```bash
cmake -S projects/chris-qsim -B build/chris-qsim-bench -DCMAKE_BUILD_TYPE=Release -DCHRIS_BUILD_BENCHMARKS=ON
cmake --build build/chris-qsim-bench --config Release
```

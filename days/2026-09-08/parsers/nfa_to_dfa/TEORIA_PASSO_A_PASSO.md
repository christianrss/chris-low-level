# Teoria passo a passo — nfa_to_dfa

Este laboratório veio da **trilha paralela GitHub** do dia 2026-09-08.

## 1. O quê

Construcao de DFA: epsilon-closure, subset construction, match.
...
| ID | Papel |
|----|-------|
| `D6-DFA-CLOSURE` | contrato do assert correspondente |
| `D6-DFA-SUBSET` | contrato do assert correspondente |
| `D6-DFA-MATCH` | contrato do assert correspondente |
...
## Nota operacional 1 — parsers/nfa_to_dfa
...
## Nota operacional 2 — parsers/nfa_to_dfa
...
## Nota operacional 3 — parsers/nfa_to_dfa
...
## Nota operacional 4 — parsers/nfa_to_dfa
...
## Nota operacional 5 — parsers/nfa_to_dfa
...
## Nota operacional 6 — parsers/nfa_to_dfa
...
## Nota operacional 7 — parsers/nfa_to_dfa
...
## Nota operacional 8 — parsers/nfa_to_dfa
...
## Nota operacional 9 — parsers/nfa_to_dfa
...
## Nota operacional 10 — parsers/nfa_to_dfa
...
## Nota operacional 11 — parsers/nfa_to_dfa

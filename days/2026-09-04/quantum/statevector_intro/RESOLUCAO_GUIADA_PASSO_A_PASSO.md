# Resolução guiada — Quantum state-vector do zero

## Etapa 1 — leitura da arquitetura
Leia `projects/chris-qsim/README.md` e `docs/architecture.md`. Identifique estado, invariantes e APIs antes de editar.
...
## Solução final
A implementação validada está em `projects/chris-qsim` e foi copiada em `solutions/` para estudo comparativo.

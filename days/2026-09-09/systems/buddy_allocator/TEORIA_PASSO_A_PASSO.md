# Teoria passo a passo — buddy_allocator
...
| ID | Papel |
|----|-------|
| `D7-BUDDY-INIT` | assert do teste |
| `D7-BUDDY-ALLOC` | assert do teste |
| `D7-BUDDY-FREE` | assert do teste |

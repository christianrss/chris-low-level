# Teoria passo a passo — branch_predictor
...
| ID | Papel |
|----|-------|
| `D7-BR-INIT` | assert do teste |
| `D7-BR-PRED` | assert do teste |
| `D7-BR-UPDATE` | assert do teste |

# Resolução guiada — Tensor, strides e matrix multiplication

## Etapa 1 — leitura da arquitetura
Leia `projects/chris-tensor/README.md` e `docs/architecture.md`. Identifique estado, invariantes e APIs antes de editar.
...
## Solução final
A implementação validada está em `projects/chris-tensor` e foi copiada em `solutions/` para estudo comparativo.

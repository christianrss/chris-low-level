# Teoria passo a passo — length_prefixed_framing
...
| ID | Papel |
|----|-------|
| `D9-NET-ENCODE` | assert do teste |
| `D9-NET-DECODE` | assert do teste |
| `D9-NET-FEED` | assert do teste |

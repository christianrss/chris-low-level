# Teoria passo a passo — channel_backpressure

Laboratório em **csharp** (trilha GitHub incorporada ao dia).
...
| ID | Papel |
|----|-------|
| `D7-DN-CHANNEL` | assert do teste |
| `D7-DN-PRODUCER` | assert do teste |
| `D7-DN-CONSUMER` | assert do teste |

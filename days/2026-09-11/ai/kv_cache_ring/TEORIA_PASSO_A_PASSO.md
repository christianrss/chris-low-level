# Teoria passo a passo — kv_cache_ring
...
| ID | Papel |
|----|-------|
| `D9-KV-WRITE` | assert do teste |
| `D9-KV-READ` | assert do teste |
| `D9-KV-WINDOW` | assert do teste |

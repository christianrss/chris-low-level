...
# Treino Low-Level Graphics — 2026-09-06 — Verlet Rope 3D

Lab: **Verlet Vec3** (corda pendurada), **sala wireframe 3D**, **câmera orbit** (arrastar mouse), backends **CPU DIB** (`portal_sw.exe`) e **OpenGL WGL** (`portal_demo.exe`). Portais/stencil ficam no capstone `projects/chris-lantern-hunt`.

# Benchmark guiado — Chris OS: primeiro compositor gráfico de referência
...
## Build
```bash
cmake -S projects/chris-os -B build/chris-os-bench -DCMAKE_BUILD_TYPE=Release -DCHRIS_BUILD_BENCHMARKS=ON
cmake --build build/chris-os-bench --config Release
```

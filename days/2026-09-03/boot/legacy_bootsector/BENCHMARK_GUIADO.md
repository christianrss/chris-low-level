# Benchmark guiado - Boot sector BIOS de 512 bytes
...
7. O benchmark de referencia esta em `projects/chris-boot/benchmarks/` quando existe.
...
|---------|------------------|-------|
| Layout test | N/A (byte model) | QEMU opcional |

# Resolução guiada — Arena Allocator e alinhamento

## Etapa 1 — leitura da arquitetura
Leia `projects/chris-arena/README.md` e `docs/architecture.md`. Identifique estado, invariantes e APIs antes de editar.
...
## Solução final
A implementação validada está em `projects/chris-arena` e foi copiada em `solutions/` para estudo comparativo.

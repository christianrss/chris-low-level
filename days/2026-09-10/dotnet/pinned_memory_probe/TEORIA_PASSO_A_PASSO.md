# Teoria passo a passo — pinned_memory_probe
...
| ID | Papel |
|----|-------|
| `D8-DN-PIN` | assert do teste |
| `D8-DN-LEN` | assert do teste |
| `D8-DN-SUM` | assert do teste |

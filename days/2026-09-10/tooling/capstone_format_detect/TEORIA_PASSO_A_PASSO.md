# Teoria passo a passo — Detect de formato por assinatura

Este laboratório é em **Python**.

## 1. O que estamos construindo

PNG e outros: match_signature + dict format/confidence — irmão do triage redteam com API de tooling.
...
1. compare prefixo PNG (89 50 4E 47…).
...
libmagic; aqui tabelas explícitas.

## Modelo mental

prefixo → formato + score.

## Por quê confidence 1.0?

Match exato do magic.

## Por quê PNG no teste?

Assinatura clássica de 8 bytes.

## Invariante

format e match_signature concordam.
...
### Por quê medir?
O `BENCHMARK_GUIADO.md` pede a métrica `1e5 match_signature` — mesmo que o ambiente
...
Neste módulo `tooling/capstone_format_detect`, o fluxo de dados não é abstrato: cada função do starter

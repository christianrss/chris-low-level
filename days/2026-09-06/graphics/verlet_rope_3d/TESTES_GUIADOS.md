...
## Caso 7 — Wireframe CPU (GFX-PORTAL-SW-07)

**Marcador:** `PEDAGOGY-TEST: GFX-PORTAL-SW-07` em `starter/software_win32/main.cpp`.

Build `portal_sw`; mesma cena wireframe que `portal_demo` (sem stencil — recorte lógico CPU).
...
Equivalente ao Caso 6: janela OpenGL com corda Verlet, dois portais e recorte stencil visível ao atravessar o plano do portal.

Compare com `portal_sw` (GFX-PORTAL-SW-07): mesma posição de esfera/corda em wireframe CPU.

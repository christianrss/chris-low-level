# Teoria passo a passo — pratt_expr
...
| ID | Papel |
|----|-------|
| `D7-PRATT-LEX` | assert do teste |
| `D7-PRATT-NUD` | assert do teste |
| `D7-PRATT-LED` | assert do teste |

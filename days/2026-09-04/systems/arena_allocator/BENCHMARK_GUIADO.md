# Benchmark guiado — Arena Allocator e alinhamento
...
## Build
```bash
cmake -S projects/chris-arena -B build/chris-arena-bench -DCMAKE_BUILD_TYPE=Release -DCHRIS_BUILD_BENCHMARKS=ON
cmake --build build/chris-arena-bench --config Release
```

# Exercícios — Agent loop capstone

Cada nível mapeia aos TODOs `CAP-AGENT-01`, `CAP-AGENT-02`, `CAP-AGENT-03`.

## Fácil

FSM no papel.

**Arquivo-alvo:** `starter/capstone_agent_loop.py`  
...
Injetar evento e ver replay falhar.

# Teoria passo a passo — async_context
...
| ID | Papel |
|----|-------|
| `D7-NODE-ALS` | assert do teste |
| `D7-NODE-RUN` | assert do teste |
| `D7-NODE-GET` | assert do teste |

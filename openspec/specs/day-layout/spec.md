...
Each module folder SHALL contain seven canonical pedagogical Markdown
files plus `starter/` and `solutions/`.
...
### Requirement: Depth-first day artifacts

- **WHEN** a day uses `profile: depth_first`
- **THEN** it SHALL also include `day.contract.yaml`, `ASSESSMENT.yaml`
  and `RUBRIC.md`

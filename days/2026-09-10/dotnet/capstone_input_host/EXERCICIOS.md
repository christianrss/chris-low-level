# Exercícios — Host de input com Span (.NET)

Cada nível mapeia aos TODOs `CAP-DN-HOST-01`, `CAP-DN-HOST-02`, `CAP-DN-HOST-03`.

## Fácil

Leia o assert numérico do teste e anote.

**Arquivo-alvo:** `starter/InputHost.cs`  

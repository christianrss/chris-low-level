# Benchmark guiado — Pesquisa empírica: merge sort vs quicksort
...
## Build
```bash
cmake -S projects/chris-algorithms -B build/chris-algorithms-bench -DCMAKE_BUILD_TYPE=Release -DCHRIS_BUILD_BENCHMARKS=ON
cmake --build build/chris-algorithms-bench --config Release
```

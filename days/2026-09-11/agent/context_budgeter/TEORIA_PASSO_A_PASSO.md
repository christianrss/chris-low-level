# Teoria passo a passo — context_budgeter
...
| ID | Papel |
|----|-------|
| `D9-CTX-SCORE` | assert do teste |
| `D9-CTX-DEDUPE` | assert do teste |
| `D9-CTX-DIVERSITY` | assert do teste |
| `D9-CTX-BUDGET` | assert do teste |

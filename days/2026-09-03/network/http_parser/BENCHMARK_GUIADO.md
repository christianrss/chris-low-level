# Benchmark guiado - HTTP incremental do zero
...
7. O benchmark de referencia esta em `projects/chris-http/benchmarks/` quando existe.
...
|---------|------------------|-------|
| HTTP parse throughput | ~1.67M req/s | 200k requests |

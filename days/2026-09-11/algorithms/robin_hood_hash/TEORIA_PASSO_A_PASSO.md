# Teoria passo a passo — robin_hood_hash
...
| ID | Papel |
|----|-------|
| `D9-RH-INSERT` | assert do teste |
| `D9-RH-LOOKUP` | assert do teste |
| `D9-RH-PROBE` | assert do teste |

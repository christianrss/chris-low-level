# Teoria passo a passo — worker_transfer

Este laboratório veio da **trilha paralela GitHub** do dia 2026-09-08.

## 1. O quê

Worker threads + transferables (ArrayBuffer muda de dono).
...
| ID | Papel |
|----|-------|
| `D6-NODE-WORKER` | contrato do assert correspondente |
| `D6-NODE-TRANSFER` | contrato do assert correspondente |
| `D6-NODE-RECEIVE` | contrato do assert correspondente |
...
## Nota operacional 1 — nodejs/worker_transfer
...
## Nota operacional 2 — nodejs/worker_transfer
...
## Nota operacional 3 — nodejs/worker_transfer
...
## Nota operacional 4 — nodejs/worker_transfer
...
## Nota operacional 5 — nodejs/worker_transfer
...
## Nota operacional 6 — nodejs/worker_transfer
...
## Nota operacional 7 — nodejs/worker_transfer
...
## Nota operacional 8 — nodejs/worker_transfer
...
## Nota operacional 9 — nodejs/worker_transfer
...
## Nota operacional 10 — nodejs/worker_transfer
...
## Nota operacional 11 — nodejs/worker_transfer

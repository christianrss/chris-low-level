# Testes guiados - P2P: gossip e deduplicacao
...
A solucao limpa e seus testes estao em `solutions/` e em `projects/chris-p2p/`. Leia os testes somente depois de tentar escrever sua propria versao.

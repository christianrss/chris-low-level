# Teoria passo a passo — transactional_patcher
...
| ID | Papel |
|----|-------|
| `D8-PATCH-BEGIN` | assert do teste |
| `D8-PATCH-APPLY` | assert do teste |
| `D8-PATCH-COMMIT` | assert do teste |

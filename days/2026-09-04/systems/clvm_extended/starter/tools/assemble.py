#!/usr/bin/env python3
"""Starter assembler — Dia 01 completo; stubs para ISA estendida."""
...
OPS = {
    ...
    "PRINT": 0x07,
    "HALT": 0x08,
    # TODO [CLVM-EXT-01]: RET 0x0C, LOAD 0x0D, STORE 0x0E, DROP 0x0F, SWAP 0x10, EQ 0x11, LT 0x12
}

BRANCH = {
    "JMP": 0x09,
    "JZ": 0x0A,
    # TODO [CLVM-EXT-01]: CALL 0x0B, JNZ 0x13
}

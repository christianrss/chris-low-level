# Benchmark guiado — Tensor, strides e matrix multiplication
...
## Build
```bash
cmake -S projects/chris-tensor -B build/chris-tensor-bench -DCMAKE_BUILD_TYPE=Release -DCHRIS_BUILD_BENCHMARKS=ON
cmake --build build/chris-tensor-bench --config Release
```

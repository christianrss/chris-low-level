# Teoria passo a passo — jit_callsite_model
...
| ID | Papel |
|----|-------|
| `D9-DN-VIRT` | assert do teste |
| `D9-DN-DEVIRT` | assert do teste |
| `D9-DN-TYPE` | assert do teste |

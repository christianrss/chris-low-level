# Teoria passo a passo — elf64_relocation_triage
...
| ID | Papel |
|----|-------|
| `D8-ELF-MAGIC` | assert do teste |
| `D8-ELF-CLASS` | assert do teste |
| `D8-ELF-RELOC` | assert do teste |

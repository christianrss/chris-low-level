# Teoria passo a passo — worker_pool_scheduler

Laboratório em **javascript** (trilha GitHub incorporada ao dia).
...
| ID | Papel |
|----|-------|
| `D9-NODE-POOL` | assert do teste |
| `D9-NODE-SUBMIT` | assert do teste |
| `D9-NODE-SHUT` | assert do teste |

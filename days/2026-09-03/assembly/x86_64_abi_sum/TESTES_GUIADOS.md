# Testes guiados - Assembly x86-64 e ABI
...
A solucao limpa e seus testes estao em `solutions/` e em `projects/chris-assembly-lab/`. Leia os testes somente depois de tentar escrever sua propria versao.
...
- `ASM-SUM-01` — coberto pela sequência de testes/validação descrita neste arquivo; a solução correspondente também é verificada pelo `pedagogy_check`.

Arquivos de teste automatizado presentes no starter:
- `starter/tests/test_sum.c`

...
struct Layer { const Surface* surface = nullptr; int x = 0; int y = 0; };

class Compositor {
public:
    static Surface compose(std::size_t width, std::size_t height, Pixel background, const std::vector<Layer>& layers);
};

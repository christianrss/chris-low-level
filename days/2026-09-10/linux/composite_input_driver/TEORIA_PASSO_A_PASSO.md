# Teoria passo a passo — Driver composto de input
...
uinput cria devices compostos reais.

## Modelo mental

device → eventos → SYN delimita pacote.

## Por quê (0,0,0)?

EV_SYN/SYN_REPORT clássico.

## Por quê composite0?

Nome estável para assert.

## Invariante

Todo frame lógico termina em SYN.

## Ligação

unified_input_pipeline consome eventos parecidos.

## Paper

Desenhe um frame KEY+SYN.
...
### Por quê medir?
O `BENCHMARK_GUIADO.md` pede a métrica `1e5 frames` — mesmo que o ambiente
...
Neste módulo `linux/composite_input_driver`, o fluxo de dados não é abstrato: cada função do starter

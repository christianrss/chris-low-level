# Resolução guiada — Red Team seguro: triagem ELF64

## Etapa 1 — leitura da arquitetura
Leia `projects/chris-binary-toolkit/README.md` e `docs/architecture.md`. Identifique estado, invariantes e APIs antes de editar.
...
## Solução final
A implementação validada está em `projects/chris-binary-toolkit` e foi copiada em `solutions/` para estudo comparativo.

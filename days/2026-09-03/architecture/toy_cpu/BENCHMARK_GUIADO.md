# Benchmark guiado - CPU: fetch/decode/execute
...
7. O benchmark de referencia esta em `projects/chris-cpu/benchmarks/` quando existe.
...
|---------|------------------|-------|
| MIPS (5000×130 instr) | ~123 | chris-cpu benchmark |

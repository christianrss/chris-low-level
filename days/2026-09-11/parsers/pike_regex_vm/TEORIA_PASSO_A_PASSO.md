# Teoria passo a passo — pike_regex_vm
...
| ID | Papel |
|----|-------|
| `D9-PIKE-EPSILON` | assert do teste |
| `D9-PIKE-STEP` | assert do teste |
| `D9-PIKE-TRACE` | assert do teste |
| `D9-PIKE-MATCH` | assert do teste |

# Teoria passo a passo — aba_tagged_freelist
...
| ID | Papel |
|----|-------|
| `D8-ABA-PUSH` | assert do teste |
| `D8-ABA-POP` | assert do teste |
| `D8-ABA-TAG` | assert do teste |

# Teoria passo a passo — xargs_lite

Este laboratório veio da **trilha paralela GitHub** do dia 2026-09-08.

## 1. O quê

xargs educacional: split, batch por limite, run com shell=False.
...
| ID | Papel |
|----|-------|
| `D6-XARGS-SPLIT` | contrato do assert correspondente |
| `D6-XARGS-BATCH` | contrato do assert correspondente |
| `D6-XARGS-RUN` | contrato do assert correspondente |
...
## Nota operacional 1 — unix/xargs_lite
...
## Nota operacional 2 — unix/xargs_lite
...
## Nota operacional 3 — unix/xargs_lite
...
## Nota operacional 4 — unix/xargs_lite
...
## Nota operacional 5 — unix/xargs_lite
...
## Nota operacional 6 — unix/xargs_lite
...
## Nota operacional 7 — unix/xargs_lite
...
## Nota operacional 8 — unix/xargs_lite
...
## Nota operacional 9 — unix/xargs_lite
...
## Nota operacional 10 — unix/xargs_lite
...
## Nota operacional 11 — unix/xargs_lite

# Teoria passo a passo — proc_stat_parser
...
| ID | Papel |
|----|-------|
| `D7-PROC-PREFIX` | assert do teste |
| `D7-PROC-FIELDS` | assert do teste |
| `D7-PROC-SELF` | assert do teste |
